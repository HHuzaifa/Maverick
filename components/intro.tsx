    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/Machine Learning Engineer, Full Stack Developer, Maverick, Huzaifa Khan.png"
              alt="Huzaifa Portriate"
              width="192"
              height="192"
              quality="95"
              priority={true}
          ...
          <motion.span
            className="absolute bottom-0 right-5 bottom-3 text-4xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
